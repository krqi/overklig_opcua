...
from nodes import *
from nodeset import *
from backend_opcua_nodes import generateNodeCode_begin, generateNodeCode_finish, generateReferenceCode
...
def generateopcuaCode(nodeset, outfilename, internal_headers=False, typesArray=[]):
